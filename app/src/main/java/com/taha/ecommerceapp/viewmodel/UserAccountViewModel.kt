...
import com.taha.ecommerceapp.Alm3sraaApplication
...
import com.taha.ecommerceapp.util.validationEmail
...
class UserAccountViewModel @Inject constructor(
    ...
    app: Application // application used to access the content resolver
    ...
    fun updateUser(user: User, imageUri: Uri?) {
        ...
        if (!areInputsValid) {
            viewModelScope.launch { _user.emit(Resource.Error("Check your inputs")) }
            return
        }
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<Alm3sraaApplication>().contentResolver,
                    imageUri
                )
